...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
      <a class="navbar-brand" href="index.html">CREATIVE<span>CARS</span></a>
...
@endif
  ...
  <div class="hero-wrap ftco-degree-bg" style="background-image: url('images/cover.jpg');"
    data-stellar-background-ratio="0.5">
    <div class="overlay"></div>
    <div class="container">
      <div class="row no-gutters slider-text justify-content-start align-items-center">
        <div class="col-lg-8 ftco-animate">
          <div class="text w-100 text-left mb-md-5 pb-md-5">
            <h1 class="mb-4">Let's Start &amp; Your Comfortable Journey with Our Cars</h1>
            <p style="font-size: 18px;">Experience freedom with My Car Rental! Affordable rates, diverse vehicles,
            ...
            <a href="https://vimeo.com/45830194"
              ...
              <div class="heading-title ml-5">
                <span>Get Started with Creative Cars</span>
              </div>
            </a>
        ...
        <div class="col-md">
          <div class="ftco-footer-widget mb-4">
            ...
            <div class="block-23 mb-3">
              <ul>
                <li><span class="icon icon-map-marker"></span><span class="text">Gt road. Model Town, Phase 1
                    Wah cantt, Pakistan</span></li>
                <li><a href="#"><span class="icon icon-phone"></span><span class="text">+2 392 3929 210</span></a></li>
                <li><a href="#"><span class="icon icon-envelope"></span><span
                      class="text">creativedesk1000@gmail.com</span></a></li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-md-12 text-center">
          ...
          <p>
            ...
            <i class="" aria-hidden="true"></i> by <a href="https://www.ahteshamportfolio1000.wuaze.com/"
              target="_blank text-warning">C & D DEV</a>
          </p>
        </div>
      </div>
    </div>
